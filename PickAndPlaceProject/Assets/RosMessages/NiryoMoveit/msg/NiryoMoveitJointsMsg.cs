...
namespace RosMessageTypes.NiryoMoveit
{
    ...
    public class NiryoMoveitJointsMsg : Message
    {
        ...
        public NiryoMoveitJointsMsg()
        {
            ...
            this.assembly_joints = new double[6];
        }

        public NiryoMoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose, double[] assembly_joints)
        {
            this.joints = joints;
            this.pick_pose = pick_pose;
            this.place_pose = place_pose;
            this.assembly_joints = assembly_joints;
        }
        ...
        private NiryoMoveitJointsMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.assembly_joints, sizeof(double), 6);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            serializer.Write(this.assembly_joints);
        }
        ...
        public override string ToString()
        {
            ...
            "\nassembly_joints: " + System.String.Join(", ", assembly_joints.ToList());
        }
